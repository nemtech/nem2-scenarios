Feature: Create a multisignature contract
  ...
  Scenario Outline: An account creates an N-of-M contract
    When Alice defines a <contract> multisignature contract
  ...
  Scenario Outline: An account creates a multisignature contract setting an invalid number of minimum required cosignatures to remove a cosignatory
    When Alice defines a <contract> multisignature contract
    And she adds <first-cosignatory> as a cosignatory
    And she adds <second-cosignatory> as a cosignatory
  ...
  Scenario Outline: An account creates a multisignature contract adding twice the same cosignatory
    When Alice defines a <contract> multisignature contract
    And she adds <first-cosignatory> as a cosignatory
    And she adds <second-cosignatory> as a cosignatory
    And publishes the contract
  ...
  Scenario Outline: An account creates a multisignature contract with more than 10 cosignatories
  ...
  Scenario Outline: An account adds as a cosignatory an account which is already cosignatory of 5 multisignature contracts
  ...
  Scenario Outline: An account creates a multisignature contract adding itself as a cosignatory
    When Alice defines a <contract> multisignature contract
  ...
  Scenario Outline: An account creates a multisignature contract, adding as a cosignatory another multisignature contract where the account is a cosignatory.
  ...
  Scenario Outline: An account creates a multisignature contract deleting a cosignatory
    When Alice defines a <contract> multisignature contract
    And adds <cosignatory>  as a cosignatory
